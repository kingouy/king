."Game:Monotonous"..msg.chat_id) then
if text == Redis:get(WOLF.."Game:Monotonous"..msg.chat_id) then
Redis:del(WOLF.."Game:Monotonous"..msg.chat_id)
Redis:incrby(WOLF.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(WOLF.."Game:Countrygof"..msg.chat_id) then
if text == Redis:get(WOLF.."Game:Countrygof"..msg.chat_id) then
Redis:incrby(WOLF.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(WOLF.."Game:Countrygof"..msg.chat_id)
...
if Redis:get(WOLF.."Game:Riddles"..msg.chat_id) then
if text == Redis:get(WOLF.."Game:Riddles"..msg.chat_id) then
Redis:incrby(WOLF.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(WOLF.."Game:Riddles"..msg.chat_id)
...
if Redis:get(WOLF.."Game:Meaningof"..msg.chat_id) then
if text == Redis:get(WOLF.."Game:Meaningof"..msg.chat_id) then
Redis:incrby(WOLF.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(WOLF.."Game:Meaningof"..msg.chat_id)
...
if Redis:get(WOLF.."Game:Reflection"..msg.chat_id) then
if text == Redis:get(WOLF.."Game:Reflection"..msg.chat_id) then
Redis:incrby(WOLF.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(WOLF.."Game:Reflection"..msg.chat_id)
...
if Redis:get(WOLF.."Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return LuaTele.sendText(msg_chat_id,msg_id,"◍ عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n","md",true)  
end 
local GETNUM = Redis:get(WOLF.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(WOLF.."SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(WOLF.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(WOLF.."Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return LuaTele.sendText(msg_chat_id,msg_id,"◍ مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸︙تم اضافة { 5 } من النقاط \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(WOLF.."SADD:NUM"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(WOLF.."SADD:NUM"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(WOLF.."SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(WOLF.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(WOLF.."Game:Difference"..msg.chat_id) then
if text == Redis:get(WOLF.."Game:Difference"..msg.chat_id) then 
Redis:del(WOLF.."Game:Difference"..msg.chat_id)
Redis:incrby(WOLF.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(WOLF.."Game:Example"..msg.chat_id) then
if text == Redis:get(WOLF.."Game:Example"..msg.chat_id) then 
Redis:del(WOLF.."Game:Example"..msg.chat_id)
Redis:incrby(WOLF.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if text then
local NewCmmd = Redis:get(WOLF.."All:Get:Reides:Commands:Group"..text) or Redis:get(WOLF.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(WOLF..'Channel:Join')}, },}}
...
if tonumber(WOLF) ~= tonumber(FilesJson.BotId) then
return LuaTele.sendText(msg_chat_id,msg_id,'◍ عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end botid
...
Y = Y + 1
Redis:sadd(WOLF..'Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(WOLF.."ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(WOLF.."TheBasics:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(WOLF.."Originators:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(WOLF.."Managers:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(WOLF.."Addictive:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(WOLF.."Distinguished:Group"..GroupId,v)
end
end 
end
...
local File_Id = Message_Reply.content.document.document.remote.id
local Name_File = Message_Reply.content.document.file_name
if tonumber(Name_File:match('(%d+)')) ~= tonumber(WOLF) then 
return LuaTele.sendText(msg_chat_id,msg_id,'◍ عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end Namefile
local File = json:decode(https.request('https://api.telegram.org/bot'..Token..'/getfile?file_id='..File_Id)) 
local download_ = download('https://api.telegram.org/file/bot'..Token..'/'..File.result.file_path,''..Name_File) 
...
Redis:sadd(WOLF.."ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(WOLF.."Originators:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(WOLF.."Managers:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(WOLF.."Addictive:Group"..idg,idmod)
end;end
if v.ASAS then
...
return LuaTele.sendText(msg_chat_id,msg_id,'◍ تم استرجاع المجموعات من نسخه كينج')
else
...
os.execute('rm -rf WOLF.lua')
os.execute('wget https://adfrv.zzz.com.ua/beb/WOLF.lua')
...
Redis:set(WOLF.."LeftBot",true) 
return LuaTele.sendText(msg_chat_id,msg_id,"◍ تم تفعيل المغادره للمطورين ","md",true)
end
if (Redis:get(WOLF.."AddSudosNew"..msg_chat_id) == 'true') then
if text == "الغاء" or text == 'الغاء الامر ◍' then   
Redis:del(WOLF.."AddSudosNew"..msg_chat_id)
...
if text == 'جلب كينج ◍' or text == 'جلب نسخه احتياطيه' then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n*◍ هاذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
local Groups = Redis:smembers(WOLF..'ChekBotAdd')  
local UsersBot = Redis:smembers(WOLF..'Num:User:Pv')  
local Get_Json = '{"BotId": '..WOLF..','  
if #UsersBot ~= 0 then 
...
local President = Redis:smembers(WOLF.."TheBasics:Group"..v)
local Constructor = Redis:smembers(WOLF.."Originators:Group"..v)
local Manager = Redis:smembers(WOLF.."Managers:Group"..v)
local Admin = Redis:smembers(WOLF.."Addictive:Group"..v)
local Vips = Redis:smembers(WOLF.."Distinguished:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
File:write(Get_Json)
File:close()
return LuaTele.sendDocument(msg_chat_id,msg_id,'./'..UserBot..'.json', '*◍ تم جلب كينج\n◍ تحتوي على {'..#Groups..'} مجموعه \n◍ وتحتوي على {'..#UsersBot..'} مشترك *\n', 'md')
end
if (Redis:get(WOLF..'Channel:Redis'..msg_chat_id..msg.sender.user_id) == 'true') then
if text == 'الغاء' or text == 'الغاء الامر ◍' then 
Redis:del(WOLF..'Channel:Redis'..msg_chat_id..msg.sender.user_id)
...
local StatusMember = LuaTele.getChatMember(bana.id,WOLF).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,"\n◍ البوت عضو في القناة يرجى رفع البوت ادمن واعادة وضع الاشتراك ","md",true)  
end
Redis:set(WOLF..'Channel:Join',ChannelUser) 
...
Redis:set(WOLF..'Channel:Redis'..msg_chat_id..msg.sender.user_id,true)
return LuaTele.sendText(msg_chat_id,msg_id,"\n◍ ارسل الي الان قناة الاشتراك ","md",true)  
end
if text == 'تعطيل الاشتراك الاجباري' or text == 'حذف قناه الاشتراك ◍' then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n*◍ هاذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
Redis:del(WOLF..'Channel:Join')
...
Redis:set(WOLF..'Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
LuaTele.sendText(msg_chat_id,msg_id,'*◍ عدد احصائيات البوت الكامله \n ❲ ‹ ⚶𝑆𝑂𝑈𝑅𝐶𝐸 𝐾𝐼𝑁𝐺⚶ ›❳\n◍ عدد المجموعات : '..(Redis:scard(WOLF..'ChekBotAdd') or 0)..'\n◍ عدد المشتركين : '..(Redis:scard(WOLF..'Num:User:Pv') or 0)..'*',"md",true)  
end
...
sec = time.sec
local_time = hour..":"..min
list_zkr = Redis:smembers(WOLF.."ChekBotAdd")
if local_time then
if local_time == "0:0" and not Redis:get(WOLF.."0:done") then 
if Redis:get(WOLF.."Status:tfil"..msg.chat_id) then
if not msg.ControllerBot then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
LuaTele.sendText(Sudo_Id,0,'*\n⌛️| تم تفعيل  المجموعات المعطله :\n*',"md",true, false, false, false, reply_markup)
end
for k,v in pairs(list_zkr) do 
if msg.can_be_deleted_for_all_users == false then
return LuaTele.sendText(v,0,"\n*◍ عذرآ البوت ليس ادمن في المجموعه يرجى ترقيته وتفعيل الصلاحيات له *","md",true)  
end
LuaTele.sendText(v,0, " 🔰| تم اعاده تشغيل البوت في الجروب :","md",true)  
Redis:sadd(WOLF.."ChekBotAdd",msg_chat_id)
Redis:set(WOLF.."Status:Id",true);Redis:set(WOLF.."Status:Games",true)  ;Redis:set(WOLF.."Status:Reply",true) ;Redis:set(WOLF.."Status:ReplySudo",true) ;Redis:set(WOLF.."Status:BanId",true) ;Redis:set(WOLF.."Status:SetId",true) 
end
Redis:set(WOLF.."0:done", true)
for i = 1 , 23 ,1 do 
Redis:del(WOLF..i..":done")
end
end
end
end
...
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(WOLF.."ChekBotAdd",msg_chat_id) then
if text == "ايدي" or text =='id' or text =='Id' or text == 'ID' and msg.reply_to_message_id == 0 then
if not Redis:get(WOLF.."Status:Id"..msg_chat_id) then
return false
end
...
local TotalMsg = Redis:get(WOLF..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(WOLF..'Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumberGames = Redis:get(WOLF.."Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(WOLF.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
...
Get_Is_Id = Redis:get(WOLF.."Set:Id:Groups") or Redis:get(WOLF.."Set:Id:Group"..msg_chat_id)
if Redis:get(WOLF.."Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
...
local TotalMsg = Redis:get(WOLF..'Num:Message:User'..msg_chat_id..':'..UserId) or 0
local TotalEdit = Redis:get(WOLF..'Num:Message:Edit'..msg_chat_id..UserId) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumAdd = Redis:get(WOLF.."Num:Add:Memp"..msg.chat_id..":"..UserId) or 0
local NumberGames = Redis:get(WOLF.."Num:Add:Games"..msg.chat_id..UserId) or 0
if Get_Is_Id then
local Get_Is_Id = Get_Is_Id:gsub('#AddMem',NumAdd) 
...
Redis:set(WOLF.."allM:numdel"..msg.chat_id,Numbardel) 
...
local list = Redis:smembers(WOLF.."allM"..msg.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
...
local gmria = Redis:scard(WOLF.."allM"..msg.chat_id)  
...
Redis:del(WOLF.."Status:Del:Media"..msg.chat_id)
...
Redis:set(WOLF.."Status:Del:Media"..msg.chat_id,true)
...
local StatusMember = LuaTele.getChatMember(msg_chat_id,WOLF).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,'◍ البوت عضو في الجروب ',"md",true) 
end
local GetMemberStatus = LuaTele.getChatMember(msg_chat_id,WOLF).status
if GetMemberStatus.can_change_info then
change_info = '❬ ✅ ❭' else change_info = '❬ ❎ ❭'
end
if GetMemberStatus.can_delete_messages then
...
if not Redis:sismember(WOLF.."HELPBEVQ:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"◍ تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(WOLF.."HELPBEVQ:Groups")
Redis:del(WOLF.."HELPBEVQ:Groups", bana.id)
Redis:del(WOLF.."id:HELPBEVQ:Groups", bana.id)
...
if not Redis:sismember(WOLF.."Developers:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"◍ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(WOLF.."Developers:Groups",bana.id) 
...
if not Redis:sismember(WOLF.."TheBasicsQ:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"◍ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(WOLF.."TheBasicsQ:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(WOLF.."TheBasics:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"◍ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(WOLF.."TheBasics:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(WOLF.."Originators:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"◍ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(WOLF.."Originators:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(WOLF.."Managers:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"◍ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(WOLF.."Managers:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(WOLF.."Addictive:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"◍ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(WOLF.."Addictive:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(WOLF.."Distinguished:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"◍ تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(WOLF.."Distinguished:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(WOLF.."DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(WOLF.."DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(WOLF.."HELPBEVQ:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◍ تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(WOLF.."HELPBEVQ:Groups")
Redis:del(WOLF.."HELPBEVQ:Groups", Message_Reply.sender.user_id)
Redis:del(WOLF.."id:HELPBEVQ:Groups", Message_Reply.sender.user_id)
...
if not Redis:sismember(WOLF.."Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◍ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(WOLF.."Developers:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(WOLF.."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◍ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(WOLF.."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(WOLF.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(WOLF.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(WOLF.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(WOLF.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(WOLF.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(WOLF.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(WOLF.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(WOLF.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(WOLF.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(WOLF.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◍ تم تنزيله من المميزبن ").Reply,"md",true)  
end
end
----تنزيل تسليه -----
if TextMsg == "خول" then
if not Redis:sismember(WOLF.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(WOLF.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(WOLF.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(WOLF.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(WOLF.."twhd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◍ اتعالج خلاص 🙃 ").Reply,"md",true)  
else
Redis:srem(WOLF.."twhd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "كلب" then
if not Redis:sismember(WOLF.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(WOLF.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(WOLF.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◍ الحمار دا عقل من زمان   🙃 ").Reply,"md",true)  
else
Redis:srem(WOLF.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "سمب" then
if not Redis:sismember(WOLF.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◍ بطل يمشي ورا الحريم 😂   🙃 ").Reply,"md",true)  
else
Redis:srem(WOLF.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "قرد" then
if not Redis:sismember(WOLF.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◍ بطل يطنط علي شجر 😂   🙃 ").Reply,"md",true)  
else
Redis:srem(WOLF.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "عره" then
if not Redis:sismember(WOLF.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◍ اعقل بقا 😂   🙃 ").Reply,"md",true)  
else
Redis:srem(WOLF.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "غبي" then
if not Redis:sismember(WOLF.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◍ يارب تعقل وتبقا ذكي 😂   🙃 ").Reply,"md",true)  
else
Redis:srem(WOLF.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(WOLF.."botaua:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◍ يارب تعقل 😂   🙃 ").Reply,"md",true)  
else
Redis:srem(WOLF.."botaua:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(WOLF.."bwoman:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(WOLF.."bwoman:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(WOLF.."alpe:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◍ اعقل وبلاش خزوقه 😂   🙃 ").Reply,"md",true)  
else
Redis:srem(WOLF.."alpe:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(WOLF.."HELPBEVQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"◍ تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(WOLF.."HELPBEVQ:Groups")
Redis:del(WOLF.."HELPBEVQ:Groups", UserId)
Redis:del(WOLF.."id:HELPBEVQ:Groups", UserId)
...
if not Redis:sismember(WOLF.."Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"◍ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(WOLF.."Developers:Groups",UserId) 
...
if not Redis:sismember(WOLF.."TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"◍ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(WOLF.."TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(WOLF.."TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"◍ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(WOLF.."TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(WOLF.."Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"◍ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(WOLF.."Originators:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(WOLF.."Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"◍ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(WOLF.."Managers:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(WOLF.."Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"◍ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(WOLF.."Addictive:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(WOLF.."Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"◍ تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(WOLF.."Distinguished:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(WOLF.."HELPBEVQ:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"◍ تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:del(WOLF.."HELPBEVQ:Groups")
Redis:sadd(WOLF.."HELPBEVQ:Groups", UserId)
Redis:set(WOLF.."id:HELPBEVQ:Groups", UserId)
...
if Redis:sismember(WOLF.."TheBasicsQ:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"◍ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(WOLF.."TheBasicsQ:Group"..msg_chat_id,bana.id) 
...
if Redis:sismember(WOLF.."TheBasics:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"◍ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(WOLF.."TheBasics:Group"..msg_chat_id,bana.id) 
...
if Redis:sismember(WOLF.."Originators:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"◍ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(WOLF.."Originators:Group"..msg_chat_id,bana.id) 
...
if Redis:sismember(WOLF.."Managers:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"◍ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(WOLF.."Managers:Group"..msg_chat_id,bana.id) 
...
if not msg.Originators and not Redis:get(WOLF.."Status:SetId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"◍ تم تعطيل (الرفع) من قبل المنشئين","md",true)
end 
if Redis:sismember(WOLF.."Addictive:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"◍ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(WOLF.."Addictive:Group"..msg_chat_id,bana.id) 
...
if Redis:sismember(WOLF.."Distinguished:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"◍ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(WOLF.."Distinguished:Group"..msg_chat_id,bana.id) 
...
if Redis:sismember(WOLF.."DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(WOLF.."DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(WOLF.."HELPBEVQ:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◍ تم ترقيته مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(WOLF.."HELPBEVQ:Groups")
Redis:sadd(WOLF.."HELPBEVQ:Groups", Message_Reply.sender.user_id)
Redis:set(WOLF.."id:HELPBEVQ:Groups", Message_Reply.sender.user_id)
...
if Redis:sismember(WOLF.."Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◍ تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(WOLF.."Developers:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(WOLF.."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◍ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(WOLF.."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(WOLF.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(WOLF.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(WOLF.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◍ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(WOLF.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(WOLF.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◍ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(WOLF.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(WOLF.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◍ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(WOLF.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(WOLF.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◍ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(WOLF.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "خول" then
if ChannelJoin(msg) == false then
local chinfo = Redis:get(WOLF.."ch:admin")
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = chinfo}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n◍ عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
if Redis:sismember(WOLF.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(WOLF.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(WOLF.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(WOLF.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(WOLF.."twhd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(WOLF.."twhd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(WOLF.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(WOLF.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(WOLF.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(WOLF.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(WOLF.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(WOLF.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(WOLF.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(WOLF.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(WOLF.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◍ محدش محترمه كده كده  😂 😂 ").Reply,"md",true)  
else
Redis:sadd(WOLF.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(WOLF.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(WOLF.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(WOLF.."bwoman:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◍ هي كد كده محطوط بنتك  😂 😂 ").Reply,"md",true)  
else
Redis:sadd(WOLF.."bwoman:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(WOLF.."botaua:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◍ هو كده كده محطوط ابنك  😂 😂 ").Reply,"md",true)  
else
Redis:sadd(WOLF.."botaua:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(WOLF.."alpe:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(WOLF.."alpe:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(WOLF.."HELPBEVQ:Groups",UserId) then
...
if Redis:sismember(WOLF.."TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"◍ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(WOLF.."TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(WOLF.."TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"◍ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(WOLF.."TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(WOLF.."Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"◍ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(WOLF.."Originators:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(WOLF.."Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"◍ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(WOLF.."Managers:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(WOLF.."Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"◍ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(WOLF.."Addictive:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(WOLF.."Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"◍ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(WOLF.."Distinguished:Group"..msg_chat_id,UserId[2]) 
...
Redis:set(WOLF.."Developer:Bot:Reply"..msg.chat_id,Teext)
...
Redis:set(WOLF.."President:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(WOLF.."Constructor:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(WOLF.."PresidentQ:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(WOLF.."Manager:Group:Reply"..msg.chat_id,Teext) 
...
Redis:set(WOLF.."Admin:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(WOLF.."Vip:Group:Reply"..msg.chat_id,Teext)
...
local Info_Members = Redis:smembers(WOLF.."DevelopersQ:Groups") 
...
local Info_Members = Redis:smembers(WOLF.."Developers:Groups") 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"◍ لا يوجد مطورين حاليا , ","md",true)  
end
ListMembers = '\n*◍ قائمه مطورين البوت \n  ❲ ‹ ⚶𝑆𝑂𝑈𝑅𝐶𝐸 𝐾𝐼𝑁𝐺⚶ ›❳*\n'
...
local Info_Members = Redis:smembers(WOLF.."TheBasicsQ:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(WOLF.."TheBasics:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(WOLF.."Originators:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(WOLF.."Managers:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(WOLF.."Addictive:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(WOLF.."Distinguished:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(WOLF.."BanAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(WOLF.."ktmAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(WOLF.."BanGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(WOLF.."SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(WOLF.."kholat:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(WOLF.."wtka:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(WOLF.."twhd:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(WOLF.."klb:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(WOLF.."mar:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(WOLF.."3ra:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(WOLF.."smb:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(WOLF.."2rd:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(WOLF.."8by:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(WOLF.."alpe:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(WOLF.."botaua:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(WOLF.."bwoman:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(WOLF.."Status:Link"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"◍ تم تفعيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:set(WOLF.."Status:Welcome"..msg_chat_id,true) 
...
Redis:set(WOLF.."Status:IdPhoto"..msg_chat_id,true) 
...
Redis:set(WOLF.."Status:Reply"..msg_chat_id,true) 
...
Redis:set(WOLF.."Status:ReplySudo"..msg_chat_id,true) 
...
Redis:set(WOLF.."Status:BanId"..msg_chat_id,true) 
...
Redis:set(WOLF.."Status:tfil"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"◍ تم تفعيل التفعيل التلقائي ","md",true)
end
if TextMsg == 'اطردني' then
Redis:set(WOLF.."Status:KickMe"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"◍ تم تفعيل اطردني ","md",true)
end
if TextMsg == 'نزلني' then
Redis:set(WOLF.."Status:remMe"..msg_chat_id,true) 
...
Redis:del(WOLF.."Status:tfil"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"◍ تم تعطيل التفعيل التلقائي ","md",true)
end
if TextMsg == 'جمالي' then
Redis:del(WOLF.."Status:gamle"..msg_chat_id) 
...
Redis:del(WOLF.."Status:Id"..msg_chat_id) 
...
Redis:del(WOLF.."Status:IdPhoto"..msg_chat_id) 
...
Redis:del(WOLF.."Status:Reply"..msg_chat_id) 
...
Redis:del(WOLF.."Status:ReplySudo"..msg_chat_id) 
...
Redis:del(WOLF.."Status:BanId"..msg_chat_id) 
...
Redis:del(WOLF.."TwaslBot") 
return LuaTele.sendText(msg_chat_id,msg_id,"◍ تم تعطيل التواصل داخل البوت ","md",true)
end

end

if text and text:match('^حظر ع @(%S+)$') then
local UserName = text:match('^حظر ع @(%S+)$')
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n*◍هاذا الامر يخص⦗ '..Controller_Num(1)..' ⦘* ',"md",true)  
end
local bana = LuaTele.searchPublicChat(UserName)
...
if text and text:match('^كتم ع @(%S+)$') then
local UserName = text:match('^كتم ع @(%S+)$')
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n*◍هاذا الامر يخص⦗ '..Controller_Num(1)..' ⦘* ',"md",true)  
end
local bana = LuaTele.searchPublicChat(UserName)
...
if not msg.Originators and not Redis:get(WOLF.."Status:BanId"..msg_chat_id) then
...
if Redis:sismember(WOLF.."BanGroup:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"◍ تم حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(WOLF.."BanGroup:Group"..msg_chat_id,bana.id) 
LuaTele.setChatMemberStatus(msg.chat_id,bana.id,'banned',0)
...
if not Redis:sismember(WOLF.."BanGroup:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"◍ تم الغاء حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:srem(WOLF.."BanGroup:Group"..msg_chat_id,bana.id) 
LuaTele.setChatMemberStatus(msg.chat_id,bana.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(WOLF.."SilentGroup:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"◍ تم كتمه في الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(WOLF.."SilentGroup:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(WOLF.."SilentGroup:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"◍ تم الغاء كتمه من الجروب ").Reply,"md",true)  
else
Redis:srem(WOLF.."SilentGroup:Group"..msg_chat_id,bana.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"◍ تم الغاء كتمه من الجروب ").Reply,"md",true)  
end
end
...
if text == ('حظر ع') and msg.reply_to_message_id ~= 0 then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n*◍هاذا الامر يخص⦗ '..Controller_Num(1)..' ⦘* ',"md",true)  
end
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
...
if Redis:sismember(WOLF.."BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(WOLF.."BanAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(WOLF.."BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(WOLF.."BanAll:Groups",Message_Reply.sender.user_id) 
...
if text == ('كتم ع') and msg.reply_to_message_id ~= 0 then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n*◍هاذا الامر يخص⦗ '..Controller_Num(1)..' ⦘* ',"md",true)  
end
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
...
if Redis:sismember(WOLF.."ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(WOLF.."ktmAll:Groups",Message_Reply.sender.user_id) 
if ban.first_name then
baniusername = '*المستخدم :- *['..ban.first_name..'](tg://user?id='..ban.id..')*\nتم كتمه في الجروب\nمن قبل :- *['..bain.first_name..'](tg://user?id='..bain.id..')*\n*'
else
baniusername = 'لا يوجد'
...
if not Redis:sismember(WOLF.."ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(WOLF.."ktmAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(WOLF.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(WOLF.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
if ban.first_name then
baniusername = '*المستخدم :- *['..ban.first_name..'](tg://user?id='..ban.id..')*\n◍ تم حظره من الجروب\nمن قبل :- *['..bain.first_name..'](tg://user?id='..bain.id..')*\n*'
else
...
if not Redis:sismember(WOLF.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(WOLF.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(WOLF.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(WOLF.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
if ban.first_name then
baniusername = '*المستخدم :- *['..ban.first_name..'](tg://user?id='..ban.id..')*\nتم كتمه في الجروب\nمن قبل :- *['..bain.first_name..'](tg://user?id='..bain.id..')*\n*'
else
baniusername = 'لا يوجد'
...
if not Redis:sismember(WOLF.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(WOLF.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◍ تم الغاء كتمه من الجروب ").Reply,"md",true)  
end
end
...
if text and text:match('^حظر ع (%d+)$') then
local UserId = text:match('^حظر ع (%d+)$')
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n*◍هاذا الامر يخص⦗ '..Controller_Num(1)..' ⦘* ',"md",true)  
end
local ban = LuaTele.getUser(UserId)
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n*◍ عذرآ لا تستطيع استخدام الامر على المطور كينج  *","md",true)  
end
...
Redis:sadd(WOLF.."BanAll:Groups",UserId) 
...
if text and text:match('^كتم ع (%d+)$') then
local UserId = text:match('^كتم ع (%d+)$')
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n*◍هاذا الامر يخص⦗ '..Controller_Num(1)..' ⦘* ',"md",true)  
end
if UserId == "5151007856" then
...
if Redis:sismember(WOLF.."BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"◍ تم حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(WOLF.."BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
if ban.first_name then
...
if not Redis:sismember(WOLF.."BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"◍ تم الغاء حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:srem(WOLF.."BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(WOLF.."SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"◍ تم كتمه في الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(WOLF.."SilentGroup:Group"..msg_chat_id,UserId) 
if ban.first_name then
baniusername = '*المستخدم :- *['..ban.first_name..'](tg://user?id='..ban.id..')*\n◍ تم كتمه في الجروب\nمن قبل :- *['..bain.first_name..'](tg://user?id='..bain.id..')*\n*'
else
baniusername = 'لا يوجد'
...
if not Redis:sismember(WOLF.."SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"◍ تم الغاء كتمه من الجروب ").Reply,"md",true)  
else
Redis:srem(WOLF.."SilentGroup:Group"..msg_chat_id,UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"◍ تم الغاء كتمه من الجروب ").Reply,"md",true)  
end
end
...
if text == "نزلني" then
if not Redis:get(WOLF.."Status:remMe"..msg_chat_id) then
...
Rink = 1
elseif Redis:sismember(WOLF.."DevelopersQ:Groups",msg.sender.user_id)  then
Rink = 2
elseif Redis:sismember(WOLF.."Developers:Groups",msg.sender.user_id)  then
Rink = 3
elseif Redis:sismember(WOLF.."TheBasicsQ:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 4
elseif Redis:sismember(WOLF.."TheBasics:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 5
elseif Redis:sismember(WOLF.."Originators:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 6
elseif Redis:sismember(WOLF.."Managers:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 7
elseif Redis:sismember(WOLF.."Addictive:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 8
elseif Redis:sismember(WOLF.."Distinguished:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
Redis:srem(WOLF.."Addictive:Group"..msg_chat_id, msg.sender.user_id)
Redis:srem(WOLF.."Distinguished:Group"..msg_chat_id, msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"◍ تم تنزيلك من الادمنيه والمميزين ","md",true) 
end
end

if text == "اطردني" or text == "طردني" then
if not Redis:get(WOLF.."Status:KickMe"..msg_chat_id) then
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(WOLF.."TheBasics:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(WOLF.."Addictive:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
if text == 'المبرمج كينج ' or text == 'كينج ' or text == 'المبرمج' then  
...
Creat = " Developers FRAWN\n"
end
local photo = LuaTele.getUserProfilePhotos(UserId_Info.id)
if photo.total_count > 0 then
local TestText = "\n ◍*𝐃𝐄𝐕 𝐍𝐀𝐌𝐄* :  [".. ban.first_name.."](tg://user?id="..UserId_Info.id..")\n◍ *𝐃𝐄𝐕 𝐁𝐈𝐎* : ["..Bio.." ]\n"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
...
local TestText = "  ❲ Developers FRAWN ❳\n— — — — — — — — —\n ◍*Dev Name* :  [".. ban.first_name.."](tg://user?id="..Sudo_Id..")\n◍ *Dev Bio* : [❲ "..Bio.." ❳]"
local msg_id = msg.id/2097152/0.5 
...
local photo = LuaTele.getUserProfilePhotos(UserId_Info.id)
if photo.total_count > 0 then
local TestText = "  ❲ ‹ 𓆩 آلآمـــيرهةة 𓆪‌‌‏ ›❳\n— — — — — — — — —\n ◍*Dev Name* :  [".. ban.first_name.."](tg://user?id="..UserId_Info.id..")\n◍ *Dev Bio* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = Creat, url = "https://t.me/"..ban.username..""},
...
if text == 'كينج' or text == 'كنج' or text == 'المبرمج كينج' then  
local UserId_Info = LuaTele.searchPublicChat("TR_E2S_ON_MY_MOoN")
if UserId_Info.id then
local  ban = LuaTele.getUser(UserId_Info.id)
local  bain = LuaTele.getUserFullInfo(UserId_Info.id)
...
if text == '' or text == '' then  
local UserId_Info = LuaTele.searchPublicChat("SOo_WOLF/408")
if UserId_Info.id then
local  ban = LuaTele.getUser(UserId_Info.id)
local  bain = LuaTele.getUserFullInfo(UserId_Info.id)
if  bain.bio then
...
local Added_Me = Redis:get(WOLF.."Who:Added:Me"..msg.sender.user_id..':'..msg.sender.user_id)
if Added_Me then 
...
return LuaTele.sendText(msg_chat_id,msg_id,"*⚠️| حبيبي دا المبرمج كينج  مش بيموت*","md",true)  
end
...
keyboard.inline_keyboard = {
{
{text = 'المرحوم ⚰️', url = "https://t.me/"..ban.username..""},
},
}
local msgg = msg_id/2097152/0.5
...
if tonumber(Message_Reply.sender.user_id) == tonumber(5194316700) then
return LuaTele.sendText(msg_chat_id,msg_id,"*⚠️| حبيبي دا المبرمج كينج  مش بيتف عليه*","md",true)  
end
if tonumber(Message_Reply.sender.user_id) == tonumber(WOLF) then
return LuaTele.sendText(msg_chat_id,msg_id,"*👾| هذا بوت يهبل*","md",true)  
end
...
keyboard.inline_keyboard = {
{
{text = 'الضحيه ⚰️', url = "https://t.me/"..ban.username..""},
},
}
local msgg = msg_id/2097152/0.5
...
if not Redis:get(WOLF.."rb:bna"..msg_chat_id) then
...
if Redis:get(WOLF.."lockalllll"..msg_chat_id) == "off" then
...
Redis:sadd(WOLF.."cleaner"..msg_chat_id,msg_id)
end
...
local list = Redis:smembers(WOLF.."cleaner"..msg_chat_id)
...
LuaTele.sendText(msg_chat_id,msg_id,t,"md",true) 
Redis:del(WOLF.."zhrfa"..msg.sender.user_id) 
end



if text == "جمالي" or text == 'نسبه جمالي' then
if Redis:get(WOLF.."Status:gamle"..msg.chat_id) then
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
...
if Redis:get(WOLF.."Status:kool"..msg.chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,m,"md",true) 
end
end
if text == "صورتي" then
if Redis:get(WOLF.."Status:photo"..msg.chat_id) then
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
local ban = LuaTele.getUser(msg.sender.user_id)
...
if not msg.ControllerBot and not Redis:set(WOLF.."LeftBot") then
...
if text and Redis:get(WOLF.."addchannel"..msg.sender.user_id) == "on" then
Redis:set(WOLF.."chadmin"..msg_chat_id,text) 
LuaTele.sendText(msg_chat_id,msg_id,"◍  تم حفظ ايدي القناه","md",true)  
Redis:del(WOLF.."addchannel"..msg.sender.user_id)
end
if text == "القناه المضافه" then
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(WOLF.."chadmin"..msg_chat_id),"md",true)  
end
if text == "اضف قناه" then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*◍ هاذا الامر يخص『 '..Controller_Num(7)..' 』* ',"md",true)  
end
Redis:set(WOLF.."addchannel"..msg.sender.user_id,"on") 
...
Redis:set(WOLF.."Lock:channell"..msg_chat_id,true) 
...
Redis:del(WOLF.."Lock:channell"..msg_chat_id)  
...
Redis:set(WOLF.."Lock:text"..msg_chat_id,true) 
...
Redis:set(WOLF.."Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set(WOLF.."Lock:Join"..msg_chat_id,"kick")  
...
Redis:set(WOLF.."Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(WOLF.."Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(WOLF.."Lock:tagservr"..msg_chat_id,true)  
...
Redis:set(WOLF.."lockalllll"..msg_chat_id,"off")
...
Redis:set(WOLF.."lockalllll"..msg_chat_id,"on")
...
Redis:set(WOLF.."lockpin"..msg_chat_id,(LuaTele.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(WOLF.."Lock:edit"..msg_chat_id,true) 
...
Redis:set(WOLF.."Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(WOLF..''..lock..msg_chat_id,"del")    
end
...
Redis:del(WOLF.."Lock:AddMempar"..msg_chat_id)  
...
Redis:del(WOLF.."Lock:text"..msg_chat_id)  
...
Redis:del(WOLF.."Lock:Join"..msg_chat_id)  
...
Redis:del(WOLF.."Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(WOLF.."Lock:tagservr"..msg_chat_id)  
...
Redis:del(WOLF.."lockpin"..msg_chat_id)  
...
Redis:del(WOLF.."Lock:edit"..msg_chat_id) 
...
Redis:del(WOLF.."Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(WOLF..''..lock..msg_chat_id)    
end
...
Redis:hset(WOLF.."Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(WOLF.."Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(WOLF.."Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(WOLF.."Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(WOLF.."Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
Redis:set(WOLF.."Lock:Link"..msg_chat_id,"del")  
...
Redis:set(WOLF.."Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(WOLF.."Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(WOLF.."Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(WOLF.."Lock:Link"..msg_chat_id)  
...
Redis:set(WOLF.."Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(WOLF.."Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(WOLF.."Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(WOLF.."Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(WOLF.."Lock:User:Name"..msg_chat_id)  
...
Redis:set(WOLF.."Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(WOLF.."Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(WOLF.."Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(WOLF.."Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(WOLF.."Lock:hashtak"..msg_chat_id)  
...
Redis:set(WOLF.."Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(WOLF.."Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(WOLF.."Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(WOLF.."Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:set(WOLF..'lock:Fshar'..msg.chat_id,true) 
...
Redis:set(WOLF..'lock:Cht'..msg.chat_id,true) 
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"◍ تم قفـل السب").Lock,"md",true)  
end
...
Redis:set(WOLF..'lock:Fars'..msg.chat_id,true) 
...
Redis:del(WOLF..'lock:Fshar'..msg.chat_id) 
...
Redis:del(WOLF..'lock:Cht'..msg.chat_id) 
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"◍ تم فتح السب").unLock,"md",true)  
end
...
Redis:del(WOLF..'lock:Fars'..msg.chat_id) 
...
Redis:del(WOLF.."Lock:Cmd"..msg_chat_id)  
...
Redis:set(WOLF.."Lock:Photo"..msg_chat_id,"del")  
...
Redis:set(WOLF.."Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(WOLF.."Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(WOLF.."Lock:Photo"..msg_chat_id,"kick")  
...
Redis:del(WOLF.."Lock:Photo"..msg_chat_id)  
...
Redis:set(WOLF.."Lock:Video"..msg_chat_id,"del")  
...
Redis:set(WOLF.."Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(WOLF.."Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(WOLF.."Lock:Video"..msg_chat_id,"kick")  
...
Redis:del(WOLF.."Lock:Video"..msg_chat_id)  
...
Redis:set(WOLF.."Lock:Animation"..msg_chat_id,"del")  
...
Redis:set(WOLF.."Lock:Animation"..msg_chat_id,"ked")  
...
Redis:set(WOLF.."Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(WOLF.."Lock:Animation"..msg_chat_id,"kick")  
...
Redis:del(WOLF.."Lock:Animation"..msg_chat_id)  
...
Redis:set(WOLF.."Lock:geam"..msg_chat_id,"del")  
...
Redis:set(WOLF.."Lock:geam"..msg_chat_id,"ked")  
...
Redis:set(WOLF.."Lock:geam"..msg_chat_id,"ktm")  
...
Redis:set(WOLF.."Lock:geam"..msg_chat_id,"kick")  
...
Redis:del(WOLF.."Lock:geam"..msg_chat_id)  
...
Redis:set(WOLF.."Lock:Audio"..msg_chat_id,"del")  
...
Redis:set(WOLF.."Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(WOLF.."Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(WOLF.."Lock:Audio"..msg_chat_id,"kick")  
...
Redis:del(WOLF.."Lock:Audio"..msg_chat_id)  
...
Redis:set(WOLF.."Lock:vico"..msg_chat_id,"del")  
...
Redis:set(WOLF.."Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(WOLF.."Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(WOLF.."Lock:vico"..msg_chat_id,"kick")  
...
Redis:del(WOLF.."Lock:vico"..msg_chat_id)  
...
Redis:set(WOLF.."Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(WOLF.."Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(WOLF.."Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(WOLF.."Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(WOLF.."Lock:Keyboard"..msg_chat_id)  
...
Redis:set(WOLF.."Lock:Sticker"..msg_chat_id,"del")  
...
Redis:set(WOLF.."Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(WOLF.."Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(WOLF.."Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:del(WOLF.."Lock:Sticker"..msg_chat_id)  
...
Redis:set(WOLF.."Lock:forward"..msg_chat_id,"del")  
...
Redis:set(WOLF.."Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(WOLF.."Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(WOLF.."Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(WOLF.."Lock:forward"..msg_chat_id)  
...
Redis:set(WOLF.."Lock:Document"..msg_chat_id,"del")  
...
Redis:set(WOLF.."Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(WOLF.."Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(WOLF.."Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(WOLF.."Lock:Document"..msg_chat_id)  
...
Redis:set(WOLF.."Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(WOLF.."Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(WOLF.."Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(WOLF.."Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(WOLF.."Lock:Unsupported"..msg_chat_id)  
...
Redis:set(WOLF.."Lock:Markdaun"..msg_chat_id,"del")  
...
Redis:set(WOLF.."Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(WOLF.."Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(WOLF.."Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(WOLF.."Lock:Markdaun"..msg_chat_id)  
...
Redis:set(WOLF.."Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(WOLF.."Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(WOLF.."Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(WOLF.."Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(WOLF.."Lock:Contact"..msg_chat_id)  
...
Redis:set(WOLF.."Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(WOLF.."Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(WOLF.."Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(WOLF.."Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(WOLF.."Lock:Spam"..msg_chat_id)  
...
Redis:set(WOLF.."Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(WOLF.."Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(WOLF.."Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(WOLF.."Lock:Inlen"..msg_chat_id,"kick")  
...
Redis:del(WOLF.."Lock:Inlen"..msg_chat_id)  
...
Redis:setex(WOLF.."Set:Link"..msg_chat_id..""..msg.sender.user_id,120,true) 
...
Redis:setex(WOLF.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id, 120, true)  
...
if not Redis:get(WOLF.."Status:Welcome"..msg_chat_id) then
...
Redis:del(WOLF.."Welcome:Group"..msg_chat_id) 
...
Redis:setex(WOLF.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:del(WOLF.."Group:Rules"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"◍ تم ازالة قوانين الجروب","md",true)    
end
if text == "القوانين" then 
local Rules = Redis:get(WOLF.."Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(WOLF.."Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(WOLF.."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id,true) 
...
local list = Redis:smembers(WOLF.."List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(WOLF.."Filter:Group:"..v..msg_chat_id)  
Redis:srem(WOLF.."List:Filter"..msg_chat_id,v)  
end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(WOLF.."Filter:Group:"..v..msg_chat_id)   
...
Redis:set(WOLF..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'true')
...
Redis:set(WOLF..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'DelFilter')
return LuaTele.sendText(msg_chat_id,msg_id,'\n*◍ ارسل الان { ملصق ,متحركه ,صوره ,رساله } *',"md",true)  
end
...
Redis:set(WOLF.."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(WOLF.."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(WOLF.."All:Command:List:Group")
for k,v in pairs(list) do
Redis:del(WOLF.."All:Get:Reides:Commands:Group"..v)
Redis:del(WOLF.."All:Command:List:Group")
end
...
for k,v in pairs(list) do
Commands = Redis:get(WOLF.."All:Get:Reides:Commands:Group"..v)
if Commands then 
...
Redis:set(WOLF.."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
return LuaTele.sendText(msg_chat_id,msg_id,"◍ الان ارسل لي الامر القديم ...","md",true)
end
...
Redis:set(WOLF.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
return LuaTele.sendText(msg_chat_id,msg_id,"◍ ارسل الان الامر الذي قمت بوضعه مكان الامر القديم","md",true)
end
...
local list = Redis:smembers(WOLF.."Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(WOLF.."Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(WOLF.."Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(WOLF.."Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
Command = Command..""..k..": ("..v..") ← {"..Commands.."}\n"
else
Command = Command..""..k..": ("..v..") \n"
...
if Redis:get(WOLF.."Status:Link"..msg.chat_id) then
Statuslink = '❬ ✅ ❭' else Statuslink = '❬ ❎ ❭'
end
if Redis:get(WOLF.."Status:Welcome"..msg.chat_id) then
StatusWelcome = '❬ ✅ ❭' else StatusWelcome = '❬ ❎ ❭'
end
if Redis:get(WOLF.."Status:Id"..msg.chat_id) then
StatusId = '❬ ✅ ❭' else StatusId = '❬ ❎ ❭'
end
if Redis:get(WOLF.."Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '❬ ✅ ❭' else StatusIdPhoto = '❬ ❎ ❭'
end
if Redis:get(WOLF.."Status:Reply"..msg.chat_id) then
StatusReply = '❬ ✅ ❭' else StatusReply = '❬ ❎ ❭'
end
if Redis:get(WOLF.."Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '❬ ✅ ❭' else StatusReplySudo = '❬ ❎ ❭'
end
if Redis:get(WOLF.."Status:BanId"..msg.chat_id)  then
StatusBanId = '❬ ✅ ❭' else StatusBanId = '❬ ❎ ❭'
end
if Redis:get(WOLF.."Status:SetId"..msg.chat_id) then
StatusSetId = '❬ ✅ ❭' else StatusSetId = '❬ ❎ ❭'
end
if Redis:get(WOLF.."Status:Games"..msg.chat_id) then
StatusGames = '❬ ✅ ❭' else StatusGames = '❬ ❎ ❭'
end
if Redis:get(WOLF.."Status:KickMe"..msg.chat_id) then
Statuskickme = '❬ ✅ ❭' else Statuskickme = '❬ ❎ ❭'
end
if Redis:get(WOLF.."Status:AddMe"..msg.chat_id) then
...
data = {
{
{text = ' ❲ ‹ ⚶𝑆𝑂𝑈𝑅𝐶𝐸 𝐾𝐼𝑁𝐺⚶ ›❳', url = 't.me/SOo_WOLF/408'}, 
},
}
}
...
Rink = 1
elseif Redis:sismember(WOLF.."DevelopersQ:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(WOLF.."Developers:Groups",Message_Reply.sender.user_id)  then
Rink = 3
elseif Redis:sismember(WOLF.."TheBasicsQ:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(WOLF.."TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(WOLF.."Originators:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(WOLF.."Managers:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
elseif Redis:sismember(WOLF.."Addictive:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 8
elseif Redis:sismember(WOLF.."Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
Rink = 1
elseif Redis:sismember(WOLF.."DevelopersQ:Groups",bana.id)  then
Rink = 2
elseif Redis:sismember(WOLF.."Developers:Groups",bana.id)  then
Rink = 3
elseif Redis:sismember(WOLF.."TheBasicsQ:Group"..msg_chat_id, bana.id) then
Rink = 4
elseif Redis:sismember(WOLF.."TheBasics:Group"..msg_chat_id, bana.id) then
Rink = 5
elseif Redis:sismember(WOLF.."Originators:Group"..msg_chat_id, bana.id) then
Rink = 6
elseif Redis:sismember(WOLF.."Managers:Group"..msg_chat_id, bana.id) then
Rink = 7
elseif Redis:sismember(WOLF.."Addictive:Group"..msg_chat_id, bana.id) then
Rink = 8
elseif Redis:sismember(WOLF.."Distinguished:Group"..msg_chat_id, bana.id) then
Rink = 9
else
Rink = 10
end
...
Redis:del(WOLF..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'◍ تم مسح جميع رسائلك ',"md",true)  
elseif text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
Redis:del(WOLF..'Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'◍ تم مسح جميع تعديلاتك ',"md",true)  
elseif text == 'مسح جهاتي' then
Redis:del(WOLF..'Num:Add:Memp'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'◍ تم مسح جميع جهاتك المضافه ',"md",true)  
elseif text == 'رسائلي' then
LuaTele.sendText(msg_chat_id,msg_id,'◍ عدد رسائلك هنا *~ '..(Redis:get(WOLF..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'◍ عدد التعديلات هنا *~ '..(Redis:get(WOLF..'Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'◍ عدد جهاتك المضافه هنا *~ '..(Redis:get(WOLF.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
Redis:setex(WOLF.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
◍ ارسل الان النص
◍ يمكنك اضافه :
...
Redis:setex(WOLF.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
◍ ارسل الان النص
◍ يمكنك اضافه :
◍ `#username` » اسم المستخدم
...
Redis:del(WOLF.."Set:Id:Group"..msg.chat_id)
...
Redis:del(WOLF.."DevelopersQ:Groups") 
...
Redis:del(WOLF.."Developers:Groups") 
...
Redis:del(WOLF.."TheBasics:Group"..msg_chat_id) 
...
Redis:del(WOLF.."Originators:Group"..msg_chat_id) 
...
Redis:del(WOLF.."Managers:Group"..msg_chat_id) 
...
Redis:del(WOLF.."Addictive:Group"..msg_chat_id) 
...
Redis:del(WOLF.."Distinguished:Group"..msg_chat_id) 
...
Redis:del(WOLF.."BanGroup:Group"..msg_chat_id) 
...
Redis:del(WOLF.."SilentGroup:Group"..msg_chat_id) 
...
local list = Redis:smembers(WOLF.."List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(WOLF.."Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(WOLF.."Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(WOLF.."Add:Rd:Manager:Stekrs"..v..msg_chat_id)     
Redis:del(WOLF.."Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(WOLF.."Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(WOLF.."Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(WOLF.."Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(WOLF.."Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(WOLF.."Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(WOLF.."List:Manager"..msg_chat_id)
end
...
text = "◍ قائمه الردود \n ❲ ‹ ⚶𝑆𝑂𝑈𝑅𝐶𝐸 𝐾𝐼𝑁𝐺⚶ ›❳\n"
for k,v in pairs(list) do
if Redis:get(WOLF.."Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه 🎭"
elseif Redis:get(WOLF.."Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه 📢"
elseif Redis:get(WOLF.."Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق 🃏"
elseif Redis:get(WOLF.."Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله ✉"
elseif Redis:get(WOLF.."Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره 🎇"
elseif Redis:get(WOLF.."Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو 📹"
elseif Redis:get(WOLF.."Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف ◍"
elseif Redis:get(WOLF.."Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه 🎵"
elseif Redis:get(WOLF.."Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(WOLF.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(WOLF.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true2")
return LuaTele.sendText(msg_chat_id,msg_id,"◍ ارسل الان الكلمه لحذفها من الردود","md",true)  
end
if text and not Redis:sismember(WOLF.."Spam:Group"..msg.sender.user_id,text) then
Redis:del(WOLF.."Spam:Group"..msg.sender.user_id) 
end
...
local list = Redis:smembers(WOLF.."List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(WOLF.."Add:Rd:Sudo:Gif"..v)   
Redis:del(WOLF.."Add:Rd:Sudo:vico"..v)   
Redis:del(WOLF.."Add:Rd:Sudo:stekr"..v)     
Redis:del(WOLF.."Add:Rd:Sudo:Text"..v)   
Redis:del(WOLF.."Add:Rd:Sudo:Photoc"..v)
Redis:del(WOLF.."Add:Rd:Sudo:Photo"..v)
Redis:del(WOLF.."Add:Rd:Sudo:Video"..v)
Redis:del(WOLF.."Add:Rd:Sudo:File"..v)
Redis:del(WOLF.."Add:Rd:Sudo:Audio"..v)
Redis:del(WOLF.."Add:Rd:Sudo:video_note"..v)
Redis:del(WOLF.."List:Rd:Sudo")
end
...
text = "\n📝︙قائمة الردود العامه \n ❲ ‹ ⚶𝑆𝑂𝑈𝑅𝐶𝐸 𝐾𝐼𝑁𝐺⚶ ›❳\n"
for k,v in pairs(list) do
if Redis:get(WOLF.."Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif Redis:get(WOLF.."Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif Redis:get(WOLF.."Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🃏"
elseif Redis:get(WOLF.."Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif Redis:get(WOLF.."Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif Redis:get(WOLF.."Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif Redis:get(WOLF.."Add:Rd:Sudo:File"..v) then
db = "ملف ◍"
elseif Redis:get(WOLF.."Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
elseif Redis:get(WOLF.."Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(WOLF.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(WOLF.."Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
...
if not msg.ControllerBot and not Redis:set(WOLF.."SendBcBot") then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*◍ امر المغادره معطل من قبل الاساسي ',"md",true)  
end
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(WOLF..'Channel:Join')}, },}}
...
Redis:setex(WOLF.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(WOLF.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(WOLF.."Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(WOLF.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(WOLF.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(WOLF..'GetTexting:DevWOLF'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(WOLF..'Texting:DevWOLF')
...
{{text = 'Delete Instagram',url="https://www.instagram.com/accounts/login/?next=/accounts/remove/request/permanent/"},{text = 'Delete Snapchat',url="https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.snapchat.com%2Faccounts%2Fdeleteaccount"}},{{text= ' ❲ ‹ ⚶𝑆𝑂𝑈𝑅𝐶𝐸 𝐾𝐼𝑁𝐺⚶ ›❳',url="https://t.me/SOo_WOLF/408"}}
}
local msg_id = msg.id/2097152/0.5
...
video = "https://t.me/ijghjvcccv/2"
local Name = '** [ ❲ ‹ 𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶 ›❳](t.me/SOo_WOLF/408)*\n\n* [ ❲ ‹𝚃𝙷𝙴𝚂𝚃𝚁𝙾𝙽𝙶𝙴𝚂𝚃 𝚂𝙾𝚄𝚁𝙲𝙴 𝙸𝙽 𝚃𝙴𝙻𝙴𝙶𝚁𝙰𝙼›❳](t.me/SOo_WOLF/408)*\n*'
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⚶𝐷𝐸𝑉 𝐾𝐼𝑁𝐺⚶',url="https://t.me/TR_E2S_ON_MY_MOoN"},{text ='⚶𝐷𝐸𝑉 𝐻𝐸𝑅𝑂⚶',url="https://t.me/H_E_R_O_V_I_P"}},
{{text = '⚶𝑆𝑂𝑈𝑅𝐶𝐸 𝐾𝐼𝑁𝐺⚶', url="https://t.me/SOo_WOLF/408"}},
}
...
Redis:setex(WOLF.."Change:Name:Bot"..msg.sender.user_id,300,true) 
...
local Namebot = (Redis:get(WOLF.."Name:Bot") or "كينج")
local BotName = {
...
if text == (Redis:get(WOLF.."Name:Bot") or "كينج") then
local photo = LuaTele.getUserProfilePhotos(WOLF)
local ban = LuaTele.getUser(WOLF)
local Namebot = (Redis:get(WOLF.."Name:Bot") or "كينج")
local BotName = {
...
local Get_Chat = LuaTele.getChat(v)
if Get_Chat.id then
local statusMem = LuaTele.getChatMember(Get_Chat.id,WOLF)
if statusMem.status.luatele == "chatMemberStatusMember" then
x = x + 1
LuaTele.sendText(Get_Chat.id,0,'*◍ البوت عظو في الجروب سوف اغادر ويمكنك تفعيلي مره اخره *',"md")
Redis:srem(WOLF..'ChekBotAdd',Get_Chat.id)
local keys = Redis:keys(WOLF..'*'..Get_Chat.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
x = x + 1
local keys = Redis:keys(WOLF..'*'..v)
for i = 1, #keys do
Redis:del(keys[i])
end
Redis:srem(WOLF..'ChekBotAdd',v)
LuaTele.leaveChat(v)
end
end
if x ~= 0 then
...
Redis:set(WOLF.."Game:Smile"..msg.chat_id,SM)
...
Text = 'ارسل اسمك واسم الشخص الثاني،  \n مثال كينج  والمبرمج احمد '
return LuaTele.sendText(msg_chat_id,msg_id,Text,"md",true) 
end
end
if text and Redis:get(WOLF..":lov_Bots"..msg.sender.user_id) == "sendlove" then
num = {"10","20","30","35","75","34","66","82","23","19","55","8","63","32","27","89","99","98","3","80","49","100","6","0",};
sendnum = num[math.random(#num)]
sl = 'نسبه حب '..text..' هي : '..sendnum..'%'
 LuaTele.sendText(msg_chat_id,msg_id,sl,"md",true) 
Redis:del(WOLF..":lov_Bots"..msg.sender.user_id)
return false
end
if text == "نسبه الكره" or text == "نسبه كره" and msg.reply_to_message_id == 0  then
if Redis:get(WOLF.."Status:Games"..msg.chat_id) then
Redis:set(WOLF..":Cick:krh"..msg.sender.user_id,"sendkrhe") 
Text = 'ارسل اسمك واسم الشخص الثاني،  \n مثال اسد و لبوى'
return LuaTele.sendText(msg_chat_id,msg_id,Text,"md",true) 
end
end
if text and Redis:get(WOLF..":Cick:krh"..msg.sender.user_id) == "sendkrhe" then
num = {"10","20","30","35","75","34","66","82","23","19","55","8","63","32","27","89","99","98","3","80","49","100","6","0",};
sendnum = num[math.random(#num)]
sl = 'نسبه كره '..text..' هي : '..sendnum..'%'
 LuaTele.sendText(msg_chat_id,msg_id,sl,"md",true) 
Redis:del(WOLF..":Cick:krh"..msg.sender.user_id)
return false
end
...
if text and Redis:get(WOLF..":hauai"..msg.sender.user_id) == "senduau" then
num = {"10","20","30","35","75","34","66","82","23","19","55","8","63","32","27","89","99","98","3","80","49","100","6","0",};
sendnum = num[math.random(#num)]
sl = 'نسبه رجوله '..text..' هي : \n '..sendnum..'%'
 LuaTele.sendText(msg_chat_id,msg_id,sl,"md",true) 
Redis:del(WOLF..":hauai"..msg.sender.user_id)
return false
end
if text == "نسبه الانوثه" or text == "نسبه انوثه"  and msg.reply_to_message_id == 0  then
if Redis:get(WOLF.."Status:Games"..msg.chat_id) then
Redis:set(WOLF..":lov_cahgf"..msg.sender.user_id,"oaoaiia") 
Text = 'ارسل اسم الشخص الذي تريد قياس نسبه انوثتها \n مثال روان'
return LuaTele.sendText(msg_chat_id,msg_id,Text,"md",true) 
end
end
if text and Redis:get(WOLF..":lov_cahgf"..msg.sender.user_id) == "oaoaiia" then
num = {"10","20","30","35","75","34","66","82","23","19","55","8","63","32","27","89","99","98","3","80","49","100","6","0",};
sendnum = num[math.random(#num)]
sl = 'نسبه الانوثه '..text..' هي : \n '..sendnum..'%'
 LuaTele.sendText(msg_chat_id,msg_id,sl,"md",true) 
Redis:del(WOLF..":lov_cahgf"..msg.sender.user_id)
return false
end
if text == "كشف الكدب" or text == "كشف الكذب" and msg.reply_to_message_id == 0  then
if Redis:get(WOLF.."Status:Games"..msg.chat_id) then
Redis:set(WOLF..":kahzm"..msg.sender.user_id,"sendnumh") 
Text = 'ارسل لى الجمله لتعرف صدق ام كذب🌚✨'
return LuaTele.sendText(msg_chat_id,msg_id,Text,"md",true) 
end
end
if text and Redis:get(WOLF..":kahzm"..msg.sender.user_id) == "sendnumh" then
...
sl = ' ⟨  '..text..'  ⟩ \n '..sendnum..' '
 LuaTele.sendText(msg_chat_id,msg_id,sl,"md",true) 
Redis:del(WOLF..":kahzm"..msg.sender.user_id)
return false
end
...
if Redis:get(WOLF.."Status:Games"..msg.chat_id) then
KlamWOLF = {"سحور","سياره","استقبال","قنفه","ايفون","بزونه","مطبخ","كرستيانو","دجاجه","مدرسه","الوان","غرفه","ثلاجه","كهوه","سفينه","العراق","محطه","طياره","رادار","منزل","مستشفى","كهرباء","تفاحه","اخطبوط","سلمون","فرنسا","برتقاله","تفاح","مطرقه","بتيته","لهانه","شباك","باص","سمكه","ذباب","تلفاز","حاسوب","انترنيت","ساحه","جسر"};
name = KlamWOLF[math.random(#KlamWOLF)]
Redis:set(WOLF.."Game:Monotonous"..msg.chat_id,name)
...
Redis:set(WOLF.."Game:Riddles"..msg.chat_id,name)
...
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دكينجين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
...
if text == "العكس" then
if Redis:get(WOLF.."Status:Games"..msg.chat_id) then
Redis:del(WOLF.."Set:Aks"..msg.chat_id)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
Redis:set(WOLF.."Game:Reflection"..msg.chat_id,name)
...
Redis:set(WOLF.."Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
...
Redis:set(WOLF.."Game:Difference"..msg.chat_id,name)
...
Redis:set(WOLF.."Game:Example"..msg.chat_id,name)
...
local NumberGame = Redis:get(WOLF.."Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:decrby(WOLF.."Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(WOLF.."Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
Redis:incrby(WOLF.."Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف مجوهرات (%d+)$"))  
...
Redis:incrby(WOLF.."Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
local Num = Redis:get(WOLF.."Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
Redis:set(WOLF.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(WOLF.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(WOLF.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(WOLF.."Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(WOLF.."Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(WOLF.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(WOLF.."Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(WOLF.."Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
Redis:set(WOLF.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مط','رفع مطور')
Redis:set(WOLF.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تنزيل الكل')
Redis:set(WOLF.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ر','الرابط')
Redis:set(WOLF.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','الردود')
Redis:set(WOLF.."Get:Reides:Commands:Group"..msg_chat_id..":"..'،،','مسح المكتومين')
Redis:set(WOLF.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:set(WOLF.."Get:Reides:Commands:Group"..msg_chat_id..":"..'سح','مسح سحكاتي')
Redis:set(WOLF.."Get:Reides:Commands:Group"..msg_chat_id..":"..'غ','غنيلي')
Redis:set(WOLF.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','رسائلي')
Redis:set(WOLF.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ثانوي','رفع كينج')
...
local ban = LuaTele.getUser(WOLF)
local bain = LuaTele.getUser(msg.sender.user_id)
Redis:sadd(WOLF..'Num:User:Pv',msg.sender.user_id)  
if not msg.ControllerBot then
if not Redis:get(WOLF.."Start:Bot") then
...
local CmdStart = '*\n◍ أهلآ بك في بوت '..(Redis:get(WOLF.."Name:Bot") or "كينج")..
'\n◍ اختصاص البوت حماية المجموعات'..
'\n◍ لتفعيل البوت عليك اتباع مايلي ...'..
'\n◍ اضف البوت الى مجموعتك'..
'\n◍ ارفعه ادمن {مشرف}'..
'\n◍ ارسل كلمة { تفعيل } ليتم تفعيل الجروب'..
'\n◍ ارسل كلمة { /play +اسم الاغنيه } لسورس الاغني'..
'\n◍ مطور البوت ↵ ⦗ @'..UserSudo..'⦘*'
if photo.total_count > 0 then
keyboard = {} 
keyboard.inline_keyboard = {
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(WOLF.."Start:Bot"),"md",false, false, false, false, reply_markup)
end
end
else
...
{
{text = 'لاشتراك الاجباري ◍',type = 'text'},
},
{
{text = 'القائمه الرئيسيه◍',type = 'text'},
},
...
Redis:setex(WOLF.."Change:Start:Bot"..msg.sender.user_id,300,true) 
...
if not msg.ControllerBot then
if Redis:get(WOLF.."TwaslBot") and not Redis:sismember(WOLF.."BaN:In:Tuasl",msg.sender.user_id) then
local ListGet = {Sudo_Id,msg.sender.user_id}
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(WOLF.."Twasl:UserId"..msg.date,172800,IdUser)
...
local Info_User = Redis:get(WOLF.."Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(WOLF..'BaN:In:Tuasl',Info_User)  
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,'◍ تم حظره من تواصل البوت ').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(WOLF..'BaN:In:Tuasl',Info_User)  
...
Redis:srem(WOLF.."ChekBotAdd",'-100'..data.supergroup.id)
local keys = Redis:keys(WOLF..'*'..'-100'..data.supergroup.id..'*')
Redis:del(WOLF.."List:Manager"..'-100'..data.supergroup.id)
Redis:del(WOLF.."Command:List:Group"..'-100'..data.supergroup.id)
for i = 1, #keys do 
Redis:del(keys[i])
end
...
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(WOLF.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(WOLF.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
if idPhoto == Redis:get(WOLF.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(WOLF.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(WOLF.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(WOLF.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(WOLF.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(WOLF.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(WOLF.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(WOLF.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(WOLF.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(WOLF.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(WOLF.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(WOLF.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(WOLF.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(WOLF.."PinMsegees:"..msg.chat_id)
end
elseif text then
if text == Redis:get(WOLF.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(WOLF.."PinMsegees:"..msg.chat_id)
end
end
...
if Redis:get(WOLF.."Lock:tagservr"..data.message.chat_id) then
LuaTele.deleteMessages(data.message.chat_id,{[1]= data.message.id})
end
end 
if tonumber(data.message.sender.user_id) == tonumber(WOLF) then
return false
end
if data.message.content.luatele == "messageChatJoinByLink" and Redis:get(WOLF..'Status:joinet'..data.message.chat_id) == 'true' then
    local reply_markup = LuaTele.replyMarkup{
    type = 'inline',
    data = {
    {
...
if Message_Edit.sender.user_id == WOLF then
print('This is Edit for Bot')
return false
end
File_Bot_Run(Message_Edit,Message_Edit)
Redis:incr(WOLF..'Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(WOLF.."Lock:edit"..data.chat_id) then
...
if Text and Text:match('/bian@(%d+)@(%d+)/(%d+)') then
local ramsesadd = {string.match(Text,"^/bian@(%d+)@(%d+)/(%d+)$")}
if tonumber(data.sender_user_id) == tonumber(ramsesadd[1]) or tonumber(ramsesadd[2]) == tonumber(data.sender_user_id) then
local inget = Redis:get(WOLF..'bainbots'..ramsesadd[3]..data.sender_user_id)
...
local reply_markup = {inline_keyboard={{{text = 'اضغط هنا لعرض الهمسه', callback_data = '/bian@'..data.sender_user_id..'@'..UserId_Info.id..'/'..idnum}}}} 
...
Redis:set(WOLF..'bainbots'..idnum..UserId_Info.id,username[1])
Redis:set(WOLF..'bainbots'..idnum..data.sender_user_id,username[1])
end
end
end
...
Redis:incrby(WOLF.."Num:Add:Games"..ChatId..IdUser, 1)  
...
"قد جربت تبكي فرح؟ وليش؟ ",
  ...
  "قد قابلت شخص تحبه؟ وولد ولا بنت؟ ",
   "هل انت تحب كينج ؟ ",
      "هل انت تحب كينج ونونا ؟ ",
         "مارأيك في هيرو الغدار ؟ ",
"اذا قفطت احد تحب تفضحه ولا تستره؟ ",
  "كلمة للشخص اللي يسب ويسطر؟ ",
  "آية من القران تؤمن فيه؟ ",
  "تحب تعامل الناس بنفس المعاملة؟ ولا تكون أطيب منهم؟ ",
...
local TextHelp = [[*
• أهلا بك في قائمة العاب سورس كينج اختر نوع الالعاب 
*]]
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
...
local TextHelp = [[*
• مرحبا بك في الالعاب المتطورة الخاص بسورس كينج 
...
Redis:set(WOLF.."zhrfa"..IdUser,"sendzh") 
end 
if Text == '/leftz@' then
LuaTele.editMessageText(ChatId,Msg_id,"*◍ ارسل الكلمه لزخرفتها عربي او انجلش*","md",true) 
Redis:set(WOLF.."zhrfa"..IdUser,"sendzh") 
...
Redis:set(WOLF.."rank_tf"..IdUser,"rank_tk") 
end
end 
...
Redis:set(WOLF.."AddSudosNew"..ChatId,true)
end
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(WOLF.."AddSudosNew"..ChatId)
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:geam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(WOLF.."Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:geam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(WOLF.."Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:geam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(WOLF.."Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:User:Name"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:hashtak"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:forward"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Lock:geam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(WOLF.."Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(WOLF.."Status:Link"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(WOLF.."Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(WOLF.."Status:Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(WOLF.."Status:IdPhoto"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(WOLF.."Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(WOLF.."Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(WOLF.."Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(WOLF.."Status:BanId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(WOLF.."Status:Games"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(WOLF.."Status:KickMe"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Status:Link"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Status:Welcome"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Status:Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Status:ReplySudo"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Status:BanId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."rb:bna"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(WOLF.."Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"◍ تم تفعيل امر اطردني").unLock, 'md', true, false, reply_markup)
end
end
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(WOLF.."TheBasics:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(WOLF.."Addictive:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(WOLF.."Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(WOLF..''..lock..UserId[2],"del")    
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:del(WOLF.."Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(WOLF..''..lock..UserId[2],"del")    
end
LuaTele.answerCallbackQuery(data.id, "◍ تم قفل جميع الاوامر بنجاح  ", true)
end
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(WOLF.."Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(WOLF.."Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(WOLF.."Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(WOLF.."Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(WOLF.."Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(WOLF.."Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(WOLF.."Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(WOLF.."Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(WOLF.."Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(WOLF.."Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(WOLF.."Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(WOLF.."Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(WOLF.."Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(WOLF.."Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(WOLF.."Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(WOLF.."Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(WOLF.."Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(WOLF.."Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(WOLF.."Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(WOLF.."Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(WOLF.."Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(WOLF.."Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(WOLF.."Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(WOLF.."Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(WOLF.."TheBasics:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(WOLF.."TheBasicsQ:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(WOLF.."Originators:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(WOLF.."Managers:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(WOLF.."Addictive:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(WOLF.."Distinguished:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(WOLF.."BanGroup:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(WOLF.."kholat:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ' ❲ ‹ ⚶𝑆𝑂𝑈𝑅𝐶𝐸 𝐾𝐼𝑁𝐺⚶ ›❳', url = 't.me/SOo_WOLF/408'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(WOLF.."wtka:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ' ❲ ‹ ⚶𝑆𝑂𝑈𝑅𝐶𝐸 𝐾𝐼𝑁𝐺⚶ ›❳', url = 't.me/SOo_WOLF/408'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(WOLF.."klb:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ' ❲ ‹ ⚶𝑆𝑂𝑈𝑅𝐶𝐸 𝐾𝐼𝑁𝐺⚶ ›❳', url = 't.me/SOo_WOLF/408'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(WOLF.."mar:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ' ❲ ‹ ⚶𝑆𝑂𝑈𝑅𝐶𝐸 𝐾𝐼𝑁𝐺⚶ ›❳', url = 't.me/SOo_WOLF/408'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(WOLF.."smb:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ' ❲ ‹ ⚶𝑆𝑂𝑈𝑅𝐶𝐸 𝐾𝐼𝑁𝐺⚶ ›❳', url = 't.me/SOo_WOLF/408'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(WOLF.."2rd:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ' ❲ ‹ ⚶𝑆𝑂𝑈𝑅𝐶𝐸 𝐾𝐼𝑁𝐺⚶ ›❳', url = 't.me/SOo_WOLF/408'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(WOLF.."3ra:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ' ❲ ‹ ⚶𝑆𝑂𝑈𝑅𝐶𝐸 𝐾𝐼𝑁𝐺⚶ ›❳', url = 't.me/SOo_WOLF/408'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(WOLF.."alpe:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ' ❲ ‹ ⚶𝑆𝑂𝑈𝑅𝐶𝐸 𝐾𝐼𝑁𝐺⚶ ›❳', url = 't.me/SOo_WOLF/408'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(WOLF.."bwoman:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ' ❲ ‹ ⚶𝑆𝑂𝑈𝑅𝐶𝐸 𝐾𝐼𝑁𝐺⚶ ›❳', url = 't.me/SOo_WOLF/408'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(WOLF.."botaua:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ' ❲ ‹ ⚶𝑆𝑂𝑈𝑅𝐶𝐸 𝐾𝐼𝑁𝐺⚶ ›❳', url = 't.me/SOo_WOLF/408'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(WOLF.."8by:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ' ❲ ‹ ⚶𝑆𝑂𝑈𝑅𝐶𝐸 𝐾𝐼𝑁𝐺⚶ ›❳', url = 't.me/SOo_WOLF/408'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(WOLF.."SilentGroup:Group"..ChatId) 
